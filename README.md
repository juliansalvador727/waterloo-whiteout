...
The default fixed-wing path is deliberately hard-coded and repeatable. It touches down at `71.9982129, -94.8420161` on heading `254.96°`, matching the captured live pose. Its first navigated landing waypoint is the supplied ocean-side point `71.9992990, -94.8431670` at 76 m, above the requested 75.99 m clearance. It then crosses east while remaining north of the mountain at `71.995786, -94.838870`, makes its large alignment turn at 55 m, and follows a straight `254.96°` descent through 35 m and 12 m gates to touchdown. Supply `--landing-mission PATH` only to intentionally override this route.
